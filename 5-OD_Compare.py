...
CBG_features['Driving_R'] = (CBG_features['Drive_alone_R'] + CBG_features['Carpool_R'] + CBG_features['Taxicab_R'])/100
...
od_flows['monthly_total'] = 2 * od_flows['monthly_total'] / (od_flows['destination_drive'] + od_flows['origin_drive'])
